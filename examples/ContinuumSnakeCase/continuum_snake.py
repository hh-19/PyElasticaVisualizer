...
def run_snake(
    ...
    if SAVE_RESULTS:
        ...
        filename = "examples/ContinuumSnakeCase/continuum_snake.dat"
    ...
    if PLOT_FIGURE:
        filename_plot = "examples/ContinuumSnakeCase/continuum_snake_velocity.png"
        ...
        if SAVE_VIDEO:
            filename_video = "examples/ContinuumSnakeCase/continuum_snake.mp4"
            plot_video(
                pp_list,
