...
if SAVE_RESULTS:
    ...
    filename = "examples/FlexibleSwingingPendulumCase/flexible_swinging_pendulum.dat"
...
if PLOT_VIDEO:
    ...
    def plot_video(
        plot_params: dict,
        video_name="examples/FlexibleSwingingPendulumCase/video.mp4",
        margin=0.2,
        fps=60,
        step=1,
        *args,
    ...
    plot_video(recorded_history, "examples/FlexibleSwingingPendulumCase/swinging_flexible_pendulum.mp4")
