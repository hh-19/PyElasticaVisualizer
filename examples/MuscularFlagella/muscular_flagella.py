...
postprocessing_dict = {"flagella_body": post_processing_dict_body,
                    "flagella_muscle": post_processing_dict_muscle}

if SAVE_VISUALIZATION_DATA:

    import pickle

    with open("examples/MuscularFlagella/visualization_data.dat", "wb") as f:
...
# Plot the videos
filename_video = "examples/MuscularFlagella/muscular_flagella.mp4"
...
plot_video_2D(
    [post_processing_dict_body, post_processing_dict_muscle],
    video_name="examples/MuscularFlagella/2d_muscular_flagella.mp4",
    fps=rendering_fps,
    step=1,
    x_limits=(-2.0, 2.0),
    y_limits=(-0.5, 0.5),
...
plot_com_position_vs_time(
    post_processing_dict_body, file_name="examples/MuscularFlagella/muscular_flagella_com_pos_vs_time.png"
)

plot_position_vs_time_comparison_cpp(
    post_processing_dict_body,
    file_name="examples/MuscularFlagella/muscular_flagella_com_pos_vs_time_comparison_with_cpp.png",
)

# Store the data for later use and plotting
import os

save_folder = "examples/MuscularFlagella/data/"
